...
import { Check, X, Star, Zap, Users, Crown, ArrowRight, MessageSquare, BarChart3, Globe, Shield, Clock, Headphones, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      ...
      <div className="py-4 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <Link href="/" className="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-white shadow-md text-gray-900 font-semibold text-sm transition-all duration-200 hover:bg-gray-100">
